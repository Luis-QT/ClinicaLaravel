...
<section class="content-header">
    <h1 class="report-title">
        Reporte de Citas por Consultorio<small> -- </small>
    </h1>
    <ol class="breadcrumb">
...
<section class="content-header">
    <div class="row">
        ...
        <div class="col-xs-3">
            <select type="text" class="form-control select2 select-office" style="width: 100%;" placeholder="Escriba el nombre">
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title table-title">Lista de citas por Consultorio</h3>
...
<script type="text/javascript">
    ...
    function filter(){
      ...
      $params = {
            ...
            'office_id'     : $('.select-office').val()
      }

      $.ajax({
        url         : '{{ url("/admin/reportsbyOffice") }}',
        type        : 'POST',
        data        : $params,
        beforeSend  : function(){
          //alert($params['office_id']);
        },
